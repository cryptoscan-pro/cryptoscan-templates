...
export default function(data) {
    ...
    return `${exchangeSymbol}${transferSymbol} отправляется ${getBigNumber(data.amount)} #${symbol} из ${data.from} в ${data.to} ([${exchange}](${getServiceUrl(exchange, symbol, 'USDT')}))\n${getAgo(new Date(data.timestamp))}`
}